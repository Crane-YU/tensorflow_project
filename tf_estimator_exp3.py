...
classifier.train(input_fn=lambda: my_input_fn("iris_training.csv", True, 10))
test_results = classifier.evaluate(input_fn=lambda: my_input_fn("iris_training.csv", False, 1))
